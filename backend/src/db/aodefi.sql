...
INSERT INTO `email_verify` VALUES (1,'admin@aoedefi.io','7895');
UNLOCK TABLES;
-- --------------------------------------------------------
...
(1, 'admin@aoedefi.io', '$2a$08$xgQCeNiE6k54YhbbJcs/huNGYWEG4Um90uv5j741lV0BuPSite3fG', 'Venezuela', 0, 'Super');
UNLOCK TABLES;
