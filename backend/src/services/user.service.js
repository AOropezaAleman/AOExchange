...
class UserService {
    ...
    static async verifyEmail(email, locale) {
        ...
        const subject = "AOExchange: Email Verification";
    ...
    static async updateUser(rawData, userId) {
        ...
        const { confirm_password, email_verify, ...restOfUpdates } = rawData;
    ...
    static async signUp(rawData) {
        ...
        const subject = "AOExchange: Account Created Sucessfully";
        const body = "Your AOExchange account has been created sucessfully. Thank you.";
