...
class WalletController {
    ...
    createMnemonic = async (req, res, next) => {
        try {
            const result = await WalletService.createMnemonic();
            res.send(result)
        } catch (error) {
            next(error)
        }
    ...
    getPriceBNB = async (req, res, next) => {
        try {
            const result = await WalletService.getPriceBNB(req.params.symbol);
            res.send(result)
        } catch (error) {
            next(error)
        }
